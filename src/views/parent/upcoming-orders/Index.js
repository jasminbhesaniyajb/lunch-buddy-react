...
const ParentUpcomingOrders = (props) => {
  ...
  return (
    <React.Fragment>
      ...
      {showReceiptPopup &&
        <OrderDetailsReseiptModal closeModal={() => setShowReceiptPopup(false)} orderId={popupIdReceiptPopup} orderBy="parent" />
      }
    </React.Fragment>
  );
};

export default ParentUpcomingOrders;
