...
import { GET_RESTAURANT_LIST } from "../../../services/ENDPOINT";

const AdminDashboardRestaurantTable = (props) => {
  ...
  const getRestaurantList = async (e) => {
    try {
      ...
      const data = await GET_RESTAURANT_LIST(payload);
          ...
          <div className="table-header-sec bg-dark-blue d-flex justify-content-between align-items-center">
            <div>
              ...
              <p className="text-white mb-0">
                List of new restaurant registration
              </p>
            </div>
...
export default AdminDashboardRestaurantTable;
