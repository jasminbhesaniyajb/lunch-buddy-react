...
import AdminHorizontalHeaderContainer from "../containers/AdminHeaderContainer";
import AdminVerticalHeader from "../components/admin/VerticalHeader";
  ...
  return (
    <React.Fragment>
      <div className="bg-light-blue">
        <AdminHorizontalHeaderContainer
        ...
        <div className="row position-relative h-100 mx-auto">
          ...
          >
            <AdminVerticalHeader showsidemenu={showHeader} />
          </div>
