...
const TeacherHorizontalHeader = (props) => {
      ...
      <div className="fixed-top bg-light box-shadow-1-light">
        <div className="d-flex justify-content-between">
          ...
          <div className="d-flex align-items-center w-100 justify-content-end">
            ...
            <Link to={"/teacher/cart-details"} className="position-relative">
              <img
                ...
                >
                  <span>
                    {props.data.loginInfo && (
                      <Avatar
                        ...
                        size={40}
                        round
                        name={props.data?.loginInfo?.teacher_name}
                      />
                    )}
                  </span>
                  <span className="d-flex flex-column justify-content-start text-left">
                    <span className="text-dark-700 ml-2 font-weight-700">
                      {props.data.loginInfo &&
                        props.data.loginInfo.teacher_name}
                    </span>
                    <small className="text-dark ml-2">Teacher</small>
                  </span>
                </Dropdown.Toggle>
...
export default TeacherHorizontalHeader;
