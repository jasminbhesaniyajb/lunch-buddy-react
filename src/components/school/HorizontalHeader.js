...
const SchoolHorizontalHeader = (props) => {
                  ...
                  <span>
                    {props.data.loginInfo && (
                      <Avatar
                        ...
                        size={40}
                        round
                        name={props?.data?.loginInfo?.contact_person_name}
                      />
                    )}
                  </span>
                  <span className="d-flex flex-column justify-content-start text-left">
                    <span className="text-dark-700 ml-2 font-weight-700">
                      {props.data.loginInfo && props.data.loginInfo.contact_person_name}
                    </span>
                    <small className="text-dark ml-2">{props.data.loginInfo && props.data.loginInfo.school_name}</small>
                  </span>
                </Dropdown.Toggle>
...
export default SchoolHorizontalHeader;
